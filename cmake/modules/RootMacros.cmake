...
function(ROOT_ADD_PYUNITTESTS name)
  set(ROOT_ENV ROOTSYS=${ROOTSYS}
      ...
      LD_LIBRARY_PATH=${ROOTSYS}/lib:${ROOTSYS}/lib/python${PYTHON_VERSION_STRING}:$ENV{LD_LIBRARY_PATH}
      PYTHONPATH=${ROOTSYS}/lib:${ROOTSYS}/lib/python${PYTHON_VERSION_STRING}:$ENV{PYTHONPATH})
